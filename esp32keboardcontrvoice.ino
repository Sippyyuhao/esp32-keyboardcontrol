...
LiquidCrystal_I2C lcd(0x27, 16, 2);//lcd1602的链接
...
#endif // ESP32_BLE_KEYBOARD_HHello world
//到这里为止为esp32的蓝牙程序和键盘宏
int x,y,z;//定义摇杆
...
void loop() 
{
  ...
  if(bleKeyboard.isConnected()) 
  {
    if (y>4000) 
    {
    Serial.println("the volume will up");
 lcd.print("the volume will up");
    ...
    {
    Serial.println("the volume will down");
   lcd.print("the volume will down");
    ...
    {
      Serial.println("the next song");
    lcd.print("the next song");
